...
public class WaterMarkUtil2 {
    ...
    public static void setImageMarkOptions(float alpha, int positionWidth,
        ...
        if (alpha != 0.0f)
        	WaterMarkUtil2.alpha = alpha;
        if (positionWidth != 0)
        	WaterMarkUtil2.positionWidth = positionWidth;
        if (positionHeight != 0)
        	WaterMarkUtil2.positionHeight = positionHeight;
        if (font != null)
        	WaterMarkUtil2.font = font;
        if (color != null)
        	WaterMarkUtil2.color = color;
    }
...
//        String srcImgPath = "D:\\users\\nll\\Desktop\\logo.jpg";
//       //String logoText = "小太阳";
//        String iconPath = "D:\\users\\nll\\Desktop\\logo2.png";
//
//        //String targerTextPath = "D:\\users\\nll\\Desktop\\logo44.jpg";
//        //String targerTextPath2 = "d:/qie_text_rotate.jpg";
//
//        String targerIconPath = "D:\\users\\nll\\Desktop\\logo55.png";
